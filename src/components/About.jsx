...
function TimelineItem({ event, index }) {
  ...
  return (
    <m.div
      ...
      className={`flex items-start gap-8 ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'} mb-16 relative`}
    >
      ...
      <div className="section-container">
        ...
        <div className="grid lg:grid-cols-2 gap-20 mb-32 items-end">
          ...
          >
            <p className="text-slate-600 dark:text-gray-300 text-lg leading-relaxed mb-6">
              {t.about.body1}{' '}
              <strong className="text-slate-900 dark:text-white">{t.about.bodyStrong}</strong> {t.about.body2}
            </p>
            <p className="text-slate-400 dark:text-white/40 text-base leading-relaxed">
              {t.about.body3}
            </p>
        ...
        >
          <div className="bg-primary/10 border border-primary/30 p-12 lg:p-20 relative">
            ...
            <blockquote
              className="font-display text-3xl lg:text-5xl font-bold text-slate-900 dark:text-white leading-snug max-w-4xl"
              style={{ overflow: 'visible' }}
            >
              "{t.about.quotePre}{' '}
              <span className="text-accent italic">{t.about.quoteAccent}</span>{' '}
              {t.about.quoteMid}"
            </blockquote>
          </div>
        </m.div>
